...
caverna2_convertido = converte_caverna2.converte_caverna2(caverna2, converte_variavel)

# Adicionar as coordenadas do ponto de partida e destino
ponto_partida = (2, 13)
ponto_destino1 = (25, 13)
...
def criar_celulas(caverna2_convertido):
    celulas = [[Celula((linha, coluna), CUSTO[caverna2_convertido[linha][coluna]]) for coluna in range(COLUNAS)] for linha in range(LINHAS)]
...
celulas = criar_celulas(caverna2_convertido)
...
for linha in range(LINHAS):
    for coluna in range(COLUNAS):
        ...
        cor = cores_terreno[caverna2_convertido[linha][coluna]]
