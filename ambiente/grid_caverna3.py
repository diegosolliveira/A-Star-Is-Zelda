...
caverna3_convertido = converte_caverna3.converte_caverna3(caverna3, converte_variavel)

# Adicionar as coordenadas do ponto de partida e destino
ponto_partida = (19, 15)
ponto_destino1 = (25, 14)
...
def criar_celulas(caverna3_convertido):
    celulas = [[Celula((linha, coluna), CUSTO[caverna3_convertido[linha][coluna]]) for coluna in range(COLUNAS)] for linha in range(LINHAS)]
...
celulas = criar_celulas(caverna3_convertido)
...
for linha in range(LINHAS):
    for coluna in range(COLUNAS):
        ...
        cor = cores_terreno[caverna3_convertido[linha][coluna]]
